...
/** * 立方体 */
class BlendedCube extends DrawGLContainerBase{
    //状态
    ...
    constructor(gl:any,container:HTMLElement){
        super(gl,container);
        this.getGLSL('./assets/glsls/chapter10/','BlendedCube');
    }
    ...
    initVertexBuffer():number{
        ...
        this.initArrayBuffer(colors,4,GL.FLOAT,'a_Color');
    ...
    resize():boolean{
        console.log('w:'+this.container.clientWidth+' h:'+this.container.clientHeight);
        this.updateViewModelMatrix();
        return true;
    }
    update(): boolean {
