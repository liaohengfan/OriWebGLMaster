...
class Matrix4{
     ...
     */
    multiplyVector3(pos:Matrix4) {
        let e:Float32Array = this.elements;
        let p:Float32Array = pos.elements;
    ...
    setInverseOf(other:Matrix4) {
        let s:Float32Array = other.elements;
        let d:Float32Array = this.elements;
     ...
     * @return this
     */
    dropShadow(plane:Array<number>, light:Array<number>) {
...
class Vector4{
    elements:Float32Array=null;
    constructor(opt_src:any=null){
        let v:Float32Array=new Float32Array(4);
        if (opt_src && typeof opt_src === 'object') {
