...
class Rotated extends DrawGLContainerBase{
    a_Position:number;
    u_FragColor:WebGLUniformLocation;
    u_CosB:WebGLUniformLocation;
    u_SinB:WebGLUniformLocation;
    constructor(gl:any,container:HTMLElement){
        super(gl,container);
        this.getGLSL('./assets/glsls/chapter3/','rotatedTriangle');
    }
    ...
    init(): boolean {
        ...
        this.u_CosB=GL.getUniformLocation(this.glProgram,'u_CosB');
        this.u_SinB=GL.getUniformLocation(this.glProgram,'u_SinB');
