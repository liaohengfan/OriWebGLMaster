...
class LookAtRotatedTriangles extends DrawGLContainerBase{
    //状态
    ...
    constructor(gl:any,container:HTMLElement){
        super(gl,container);
        this.getGLSL('./assets/glsls/chapter7/','LookAtRotatedTriangles');
    }
    ...
    init(): boolean {
        ...
        this.modelMatrix.setRotate(-10,0,0,1);//模型矩阵旋转 绕Z轴旋转-10
