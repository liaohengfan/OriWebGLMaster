...
class LookAtTriangleWithKeysView extends DrawGLContainerBase{
    //状态
    ...
    constructor(gl:any,container:HTMLElement){
        super(gl,container);
        this.getGLSL('./assets/glsls/chapter7/','LookAtTriangleWithKeysView');
    }
    ...
    init(): boolean {
        ...
        //this.projMatrix.setOrtho(-.5,.5,-.5,.5,0,2);
        this.projMatrix.setOrtho(-.3,.3,-1,1,0,2);
...
export default LookAtTriangleWithKeysView;